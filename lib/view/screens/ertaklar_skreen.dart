...
class Ertaklar extends StatefulWidget {
  const Ertaklar({Key? key}) : super(key: key);

  @override
  State<Ertaklar> createState() => _ErtaklarState();
}

class _ErtaklarState extends State<Ertaklar> {
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (ErtakData.data[index].ertak == true) {
                          return Padding(
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      if (!state.contains(index.toString())) {
                                        setState(() {
                                          _cubitIndex.itemsIndex.add(index.toString());
                                        });
                                        _cubitIndex.saveSelected(_cubitIndex.itemsIndex);
                                      } else {
                                        _cubitIndex
